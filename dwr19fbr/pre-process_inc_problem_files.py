...
def process_raw(raw_file_chunk, station_name, prev_raw_time = None):    
    ...
    # Handle no data in day chunk (need previous raw time, or else the dataset may start with NaNs) 
    # This is triggered if spt starts before raw
...
TOLERANCE = 5 # The number of additional or missing samples that are allowed in the raw files
...
if __name__ == '__main__':
    ...
    unprocessed_data_path = os.path.join(os.getcwd(),'unprocessed_data')
